repeat wait() until game.Players:FindFirstChild("Hmm465")
repeat wait() until game.Players:FindFirstChild("Hmm465").Character ~= nil


local Player = game:GetService("Players").Hmm465
...
p.CFrame = Character.Head.CFrame
p.Name = "Right Eye"
...
local reyeweld = w
local leyeweld = w2
reye.Parent = Character
leye.Parent = Character
local w2 = Instance.new("Weld", p2)
w2.Part0 = p2
w2.Part1 = Character.Head
...
tecks.TextStrokeTransparency = Head.Transparency
tecks.Position = UDim2.new(0,math.random(-3,3),0,math.random(-3,3))
tecks.Rotation = math.random(-1, 3)
tecks.Text = "evil hmm465"
end
end)
...
chatfunc("heh")
wait(2)
chatfunc("you've made me mad")
wait(3)
chatfunc("and the last thing you want is to make me mad")
wait(3)
chatfunc("now for my revenge")
wait(2)
...
kolor.Brightness = -0.1
kolor.Contrast = 0.1
wait(0.1)
kolor.Brightness = -0.2
kolor.Contrast = 0.2
wait(0.1)
kolor.Brightness = -0.3
kolor.Contrast = 0.3
wait(0.1)
kolor.Brightness = -0.4
kolor.Contrast = 0.4
wait(0.1)
kolor.Brightness = -0.5
kolor.Contrast = 0.5
wait(0.1)
kolor.Brightness = -0.6
kolor.Contrast = 0.6
wait(0.1)
kolor.Brightness = -0.7
kolor.Contrast = 0.7
wait(0.1)
kolor.Brightness = -0.8
kolor.Contrast = 0.8
wait(0.1)
kolor.Brightness = -0.9
kolor.Contrast = 0.9
wait(0.1)
kolor.Brightness = -1
kolor.Contrast = 1
...
m.Name = "WeaponModelz"
local SHEZ = Instance.new("Sound",Character.HumanoidRootPart)
SHEZ.SoundId = "rbxassetid://1383509454" 
SHEZ.Looped = true SHEZ.Volume = 100 
SHEZ.Pitch = 1
SHEZ:Play()

local mobs = Instance.new("Sound",Character.HumanoidRootPart)
mobs.SoundId = "rbxassetid://1383509454" 
mobs.Looped = true 
mobs.Volume = 100 
mobs.Pitch = 1.27

chatfunc("now its time to die! :D")
...
if attack == false and k == 'o'then
print("enabling rage mode")
SHEZ:Stop()
mobs:Play()
wait(.01)
chatfunc("this is why you shouldnt mess with me >: )")
wait(1)
rage = true
		canrage = false
		local truenumber = 0
